...
export function SectorHeroVisual({ 
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      {/* Card 1 - Top Right, on edge - White background */}
      <div className="absolute -right-2 top-3 w-36 bg-white rounded-xl p-3 shadow-xl z-10">
        {stats[0]?.icon && (
          <div className="flex items-center gap-1.5 mb-1.5">
            <div className="w-6 h-6 rounded-lg flex items-center justify-center" style={{ backgroundColor: `${stats[0].iconColor}15` }}>
              {stats[0].icon}
            </div>
      ...
      {/* Card 2 - Left side, middle - White background */}
      <div className="absolute -left-2 top-[30%] w-36 bg-white rounded-xl p-3 shadow-xl z-10">
        {stats[1]?.icon && (
          <div className="flex items-center gap-1.5 mb-1.5">
            <div className="w-6 h-6 rounded-lg flex items-center justify-center" style={{ backgroundColor: `${stats[1].iconColor}15` }}>
              {stats[1].icon}
            </div>
      ...
      {/* Card 3 - Right side, lower middle - White background */}
      <div className="absolute -right-2 top-[58%] w-36 bg-white rounded-xl p-3 shadow-xl z-10">
        {stats[2]?.icon && (
          <div className="flex items-center gap-1.5 mb-1.5">
            <div className="w-6 h-6 rounded-lg flex items-center justify-center" style={{ backgroundColor: `${stats[2].iconColor}15` }}>
              {stats[2].icon}
            </div>
      ...
      {/* Card 4 - Bottom Left, on edge - White background */}
      <div className="absolute -left-2 bottom-3 w-36 bg-white rounded-xl p-3 shadow-xl z-10">
        {stats[3]?.icon && (
          <div className="flex items-center gap-1.5 mb-1.5">
            <div className="w-6 h-6 rounded-lg flex items-center justify-center" style={{ backgroundColor: `${stats[3].iconColor}15` }}>
              {stats[3].icon}
            </div>
...
export function SectorEnjeuxVisual({
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      {/* Problem Card 1 - Top Right on edge - White background */}
      <div className="absolute -right-2 top-3 w-32 bg-white rounded-xl p-2.5 shadow-xl z-10">
        {problems[0]?.icon && (
          <div className="w-6 h-6 rounded-lg flex items-center justify-center mb-1.5 bg-red-50">
            {problems[0].icon}
          </div>
        )}
        <div className="text-lg font-bold text-[#0C0A09]">{problems[0]?.value}</div>
        <div className="text-[10px] text-gray-500">{problems[0]?.label}</div>
      </div>

      {/* Problem Card 2 - Left side on edge - White background */}
      <div className="absolute -left-2 top-[28%] w-32 bg-white rounded-xl p-2.5 shadow-xl z-10">
        {problems[1]?.icon && (
          <div className="w-6 h-6 rounded-lg flex items-center justify-center mb-1.5 bg-red-50">
            {problems[1].icon}
          </div>
        )}
        <div className="text-lg font-bold text-[#0C0A09]">{problems[1]?.value}</div>
        <div className="text-[10px] text-gray-500">{problems[1]?.label}</div>
      </div>

      {/* Problem Card 3 - Right side, lower on edge - White background */}
      <div className="absolute -right-2 top-[52%] w-32 bg-white rounded-xl p-2.5 shadow-xl z-10">
        {problems[2]?.icon && (
          <div className="w-6 h-6 rounded-lg flex items-center justify-center mb-1.5 bg-red-50">
            {problems[2].icon}
          </div>
        )}
        <div className="text-lg font-bold text-[#0C0A09]">{problems[2]?.value}</div>
        <div className="text-[10px] text-gray-500">{problems[2]?.label}</div>
      </div>

      {/* Problem Card 4 - Left side above banner - White background */}
      <div className="absolute -left-2 bottom-16 w-32 bg-white rounded-xl p-2.5 shadow-xl z-10">
        {problems[3]?.icon && (
          <div className="w-6 h-6 rounded-lg flex items-center justify-center mb-1.5 bg-red-50">
            {problems[3].icon}
          </div>
        )}
        <div className="text-lg font-bold text-[#0C0A09]">{problems[3]?.value}</div>
        <div className="text-[10px] text-gray-500">{problems[3]?.label}</div>
      </div>
...
export function SectorSolutionsVisual({
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      {/* Benefit Card 1 - Top Right on edge - White background */}
      <div className="absolute -right-2 top-3 w-32 bg-white rounded-xl p-2.5 shadow-xl z-10">
        {benefits[0]?.icon && (
        ...
        <div className="text-lg font-bold text-[#0C0A09]">{benefits[0]?.value}</div>
        <div className="text-[10px] text-gray-500">{benefits[0]?.label}</div>
      </div>

      {/* Benefit Card 2 - Left side on edge - White background */}
      <div className="absolute -left-2 top-[28%] w-32 bg-white rounded-xl p-2.5 shadow-xl z-10">
        {benefits[1]?.icon && (
        ...
        <div className="text-lg font-bold text-[#0C0A09]">{benefits[1]?.value}</div>
        <div className="text-[10px] text-gray-500">{benefits[1]?.label}</div>
      </div>

      {/* Benefit Card 3 - Right side, lower on edge - White background */}
      <div className="absolute -right-2 top-[52%] w-32 bg-white rounded-xl p-2.5 shadow-xl z-10">
        {benefits[2]?.icon && (
        ...
        <div className="text-lg font-bold text-[#0C0A09]">{benefits[2]?.value}</div>
        <div className="text-[10px] text-gray-500">{benefits[2]?.label}</div>
      </div>

      {/* Benefit Card 4 - Left side above banner - White background */}
      <div className="absolute -left-2 bottom-16 w-32 bg-white rounded-xl p-2.5 shadow-xl z-10">
        {benefits[3]?.icon && (
        ...
        <div className="text-lg font-bold text-[#0C0A09]">{benefits[3]?.value}</div>
        <div className="text-[10px] text-gray-500">{benefits[3]?.label}</div>
      </div>
