...
export default function ImmobilierPage() {
  ...
  const config = getSectorConfig('immobilier')
        ...
        <div className="relative max-w-[1240px] mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="hidden lg:block">
              <SectorHeroVisual 
                imageSrc="/images/sector-realestate.jpg"
                imageAlt="Immobilier et patrimoine"
                stats={config.heroStats}
                badge={{ text: 'Immobilier', icon: <Building2 className="w-4 h-4" /> }}
              />
            </div>
          </div>
        </div>
          ...
          <TabPanel isActive={activeTab === 'enjeux'}>
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="lg:sticky lg:top-36 flex justify-center">
                <SectorEnjeuxVisual
                  imageSrc="/images/sector-realestate-enjeux.jpg"
                  imageAlt="Défis de la maintenance immobilière"
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="lg:sticky lg:top-36 flex justify-center">
                <SectorSolutionsVisual
                  imageSrc="/images/sector-realestate-solutions.jpg"
                  imageAlt="Solutions Maintex pour l'immobilier"
