...
export default function BTPPage() {
  ...
  const config = getSectorConfig('btp')
        ...
        <div className="relative max-w-[1240px] mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="hidden lg:block">
              <SectorHeroVisual 
                imageSrc="/images/sector-construction.jpg"
                imageAlt="Engins de chantier BTP"
                stats={config.heroStats}
                badge={{ text: 'BTP & Construction', icon: <HardHat className="w-4 h-4" /> }}
              />
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-[#FAFAF9]">
        <div className="max-w-[1240px] mx-auto px-6">
          ...
          <TabPanel isActive={activeTab === 'enjeux'}>
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="lg:sticky lg:top-36 flex justify-center">
                <SectorEnjeuxVisual 
                  imageSrc="/images/sector-construction-enjeux.jpg"
                  imageAlt="Défis du secteur BTP"
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="lg:sticky lg:top-36 flex justify-center">
                <SectorSolutionsVisual 
                  imageSrc="/images/sector-construction-solutions.jpg"
                  imageAlt="Solutions Maintex pour le secteur BTP"
          ...
          <TabPanel isActive={activeTab === 'resultats'}>
            {/* Image Grid with construction site */}
            <div className="mb-12">
              <ImageGridAsymmetric
                mainImage={{
                  src: "/images/chantier-btp-diverse.png",
                  alt: "Chantier BTP"
                }}
                smallImages={[
                  { src: "/images/chantier-btp-new.png", alt: "Engins de chantier" },
                  { src: "/images/technician-african-action.png", alt: "Technicien BTP" }
                ]}
                dataCards={[
                  {
                    value: "-40%",
                    label: "Pannes",
                    change: "Imprévues",
                    icon: <TrendingDown className="w-4 h-4 text-[#059669]" />,
