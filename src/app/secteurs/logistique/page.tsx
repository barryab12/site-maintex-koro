...
export default function LogistiquePage() {
  ...
  const config = getSectorConfig('logistique')
        ...
        <div className="relative max-w-[1240px] mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="hidden lg:block">
              <SectorHeroVisual
                imageSrc="/images/sector-logistics.jpg"
                imageAlt="Logistics maintenance"
                stats={config.heroStats}
                badge={{ text: 'Logistique', icon: <Truck className="w-4 h-4" /> }}
              />
            </div>
          </div>
        </div>
          ...
          <TabPanel isActive={activeTab === 'enjeux'}>
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="lg:sticky lg:top-36 flex justify-center">
                <SectorEnjeuxVisual
                  imageSrc="/images/sector-logistics-enjeux.jpg"
                  imageAlt="Logistics challenges"
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="lg:sticky lg:top-36 flex justify-center">
                <SectorSolutionsVisual
                  imageSrc="/images/sector-logistics-solutions.jpg"
