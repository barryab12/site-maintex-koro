...
export default function OilGasPage() {
  ...
  const config = getSectorConfig('oil-gas')
        ...
        <div className="relative max-w-[1240px] mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="hidden lg:block">
              <SectorHeroVisual 
                imageSrc="/images/sector-oilgas.jpg"
                imageAlt="Plateforme pétrolière et gazière"
                stats={config.heroStats}
                badge={{ text: 'Oil & Gas', icon: <Fuel className="w-4 h-4" /> }}
              />
            </div>
          </div>
        </div>
          ...
          <TabPanel isActive={activeTab === 'enjeux'}>
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="lg:sticky lg:top-36 flex justify-center">
                <SectorEnjeuxVisual 
                  imageSrc="/images/sector-oilgas-enjeux.jpg"
                  imageAlt="Défis du secteur pétrolier et gazier"
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="lg:sticky lg:top-36 flex justify-center">
                <SectorSolutionsVisual 
                  imageSrc="/images/sector-oilgas-solutions.jpg"
                  imageAlt="Solutions Maintex pour le secteur pétrolier et gazier"
