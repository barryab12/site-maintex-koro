...
export default function AutomobilePage() {
  ...
  const config = getSectorConfig('automobile')
        ...
        <div className="relative max-w-[1240px] mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="hidden lg:block">
              <SectorHeroVisual
                imageSrc="/images/sector-automotive.jpg"
                imageAlt="Ligne de production automobile"
                stats={config.heroStats}
                badge={{ text: 'Automobile', icon: <Car className="w-4 h-4" /> }}
              />
            </div>
          </div>
        </div>
          ...
          <TabPanel isActive={activeTab === 'enjeux'}>
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="lg:sticky lg:top-36 flex justify-center">
                <SectorEnjeuxVisual
                  imageSrc="/images/sector-automotive-enjeux.jpg"
                  imageAlt="Défis maintenance automobile"
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="lg:sticky lg:top-36 flex justify-center">
                <SectorSolutionsVisual
                  imageSrc="/images/sector-automotive-solutions.jpg"
                  imageAlt="Solutions Maintex automobile"
