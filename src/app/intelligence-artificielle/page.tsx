          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="hidden lg:block relative">
              ...
              <div className="absolute top-16 right-4 bg-white rounded-xl p-4 shadow-lg">
                ...
                <div className="text-2xl font-bold text-[#0C0A09]">4 mois</div>
              </div>
              ...
              <div className="absolute bottom-4 right-4 bg-[#059669] text-white rounded-xl p-3 shadow-lg">
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4" />
                  <span className="text-sm font-semibold">-38% arrêts</span>
                </div>
              </div>
            </div>
          </div>
