...
import { TabletMockup, MobileMockup, GMAODashboardMockup, MobileTaskListMockup } from '@/components/device-mockups'
        ...
        <div className="relative z-10 max-w-[1280px] mx-auto px-6 lg:px-10 w-full">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="hidden lg:flex justify-center gap-4">
              <TabletMockup className="w-[320px]">
                <GMAODashboardMockup />
              </TabletMockup>
              <MobileMockup className="w-[160px] mt-16">
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                {sectors.map((sector, i) => (
                  <Link
                    key={i}
                    href={sector.href}
                    className="flex items-center gap-3 p-4 bg-[#FAFAF9] border border-gray-200 rounded-xl hover:border-[#F97316] hover:shadow-md transition-all no-underline group"
                  >
      ...
      <section className="py-16 bg-white border-b border-gray-100">
        <div className="max-w-[1280px] mx-auto px-6 lg:px-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { value: '350+', label: 'Sites industriels', icon: Factory },
              { value: '15', label: 'Pays francophones', icon: Globe },
              { value: '-30%', label: 'Temps d\'arrêt moyen', icon: TrendingUp },
              { value: '99.9%', label: 'Disponibilité', icon: Activity },
            ].map((stat, i) => (
              <div key={i} className="text-center">
                <div className="w-14 h-14 rounded-xl bg-[#F97316]/10 flex items-center justify-center mx-auto mb-4">
